...
PYTHONFRAMEWORKPREFIX=	/usr/local/Cellar/python3/3.6.2_1/Frameworks
PYTHONFRAMEWORKINSTALLDIR= /usr/local/Cellar/python3/3.6.2_1/Frameworks/Python.framework
