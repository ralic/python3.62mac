...
build_time_vars = {'ABIFLAGS': 'dm',
 ...
 'CFLAGS': '-fsanitize=address -fno-omit-frame-pointer  -Wno-unused-result '
           ...
           '-msse -flto -maes -march=native -fomit-frame-pointer '
           '-funroll-loops  -ffast-math -Ofast -fno-signed-zeros '
           '-ffp-contract=fast -mmmx -msse -flto -maes -march=native',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIG_ARGS': "'--enable-ipv6' '--enable-optimizations' "
                ...
                "'--prefix=/usr/local/Cellar/python3/3.6.2_1' '--with-dtrace' "
                "'CC=cc' 'CFLAGS=-fomit-frame-pointer -funroll-loops  "
                '-ffast-math -Ofast -fno-signed-zeros -ffp-contract=fast -mmmx '
                "-msse -flto -maes -march=native  ' "
 ...
 'PY_CORE_CFLAGS': '-fsanitize=address -fno-omit-frame-pointer  '
                   ...
                   '-mmmx -msse -flto -maes -march=native -fomit-frame-pointer '
                   '-funroll-loops  -ffast-math -Ofast -fno-signed-zeros '
                   '-ffp-contract=fast -mmmx -msse -flto -maes -march=native '
                   ...
                   '-funroll-loops  -ffast-math -Ofast -fno-signed-zeros '
                   '-ffp-contract=fast -mmmx -msse -flto -maes -march=native '
                   '-I. -I./Include -I/usr/local/opt/lapack/include '
                   '-I/usr/local/opt/openblas/include '
                   '-I/usr/local/opt/llvm/include '
                   '-I/usr/local/opt/sqlite/include '
                   '-I/usr/local/opt/readline/include '
